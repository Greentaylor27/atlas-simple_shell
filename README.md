...
Hello and welcome to Taylor's simple shell project. I am from Cohort 22, this program is intended to work as the shell works. By passing in shell commands, the intended output so be the correct execution of the command.
## Acknowledgements
